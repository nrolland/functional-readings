...
showBracket' []       =  nil
showBracket' ts       =  text "[" <> nest 1 (line <> showTrees ts) <> line <> text "]"
showTrees [t]        =  showTree t
showTrees (t:ts)     =  showTree t <> text "," <> line <> showTrees ts


a =  Node  "aaa"  [Node "bbbbb" [Node "ccc" [], Node "dd" []], Node "eee" [], 
                        Node "fff" [Node "gg" [], Node "hhh" [], Node "ii" []]]
